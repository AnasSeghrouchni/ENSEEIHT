...
public class PhiloSemNaive implements StrategiePhilo {
	
	private Semaphore[] fourchettes ;
	private int n;
    /****************************************************************/

    public PhiloSemNaive (int nbPhilosophes) {
    ...
    /** Le philosophe no rend les fourcAhettes.
    ...
    public String nom() {
        return "Implantation Sémaphores, stratégie naïve";
    }
