...
class followListener implements ActionListener {
	...
	class afficheur_maj implements Runnable
		{
		String chaine;
		afficheur_maj(String chaine)
			{
			this.chaine = chaine;
			}
		...
		public void run()
			{
			// display the read value
				Irc_follow.text.append(chaine+"\n");
			}
		}
		Runnable r = new afficheur_maj("L'objet a été modifié, appuyez sur read pour le lire");
		// unlock the object
		Irc_follow.sentence.follow(r);
	}
}
