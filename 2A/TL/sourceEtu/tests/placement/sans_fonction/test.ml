...
let%test "testBloc_i_1" =
  test (pathFichiersRat^"testBlocSansElseSujet.rat") "main" ("i",1) (0, "SB")

let%test "testPointeur_px" =
  test (pathFichiersRat^"testPointeurSujet.rat") "main" ("px",1) (0, "SB")

let%test "testPointeur_x" =
  test (pathFichiersRat^"testPointeurSujet.rat") "main" ("x",1) (1, "SB")

  let%test "testPointeur_y" =
  test (pathFichiersRat^"testPointeurSujet.rat") "main" ("y",1) (2, "SB")
