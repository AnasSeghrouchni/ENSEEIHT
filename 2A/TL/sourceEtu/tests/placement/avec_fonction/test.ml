...
let%test "testTernaire_a" = 
  test (pathFichiersRat^"testTernaireSujet.rat")  "main" ("a",1)  (0, "SB")

let%test "testTernaire_y" = 
  test (pathFichiersRat^"testTernaireSujet.rat")  "main" ("y",1)  (2, "SB")  
  
let%test "testTernaire_a1" = 
  test (pathFichiersRat^"testTernaireSujet.rat")  "min" ("a",1)  (-2, "LB")  

let%test "testTernaire_b" = 
  test (pathFichiersRat^"testTernaireSujet.rat")  "min" ("b",1)  (-1, "LB")  