...
type expression =
  ...
  | Binaire of binaire * expression * expression
   (* Opérateur ternaire représenté par la condition, l'opérende gauche et l'opérande droite *)
  ...
  | New of typ
  (* Adresse d'une variable réprésenté par son nom*)
  | Adresse of string
...
type affectable =
  | Ident of Tds.info_ast (* informations sur l'identifiant *)
  | Dereference of affectable
