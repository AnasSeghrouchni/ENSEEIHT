...
public class ExemplesAffichage {
	...
	public static void main(String[] args) {
		...
		// Afficher expression 1
		String e1pstfixe = expression1().accepter(postfixe);
				
		System.out.println("e1 = " + e1pstfixe);

		// Afficher expression2
		String e2psfixe = expression2().accepter(postfixe);
		System.out.println("e2 = " + e2psfixe);
	}
}
