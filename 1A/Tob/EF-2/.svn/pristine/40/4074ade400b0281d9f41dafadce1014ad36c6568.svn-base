...
// a revoir...
public class Score extends JList<String> {

    /**
	 * 
	 */
	private static final long serialVersionUID = -7771984161504407099L;
	DefaultListModel<String> text;

    public Score(DefaultListModel<String> text) {
        super(text);
        this.text = text;
    ...
    public static String[] convertir(long[] long_tableau) {
        String[] titre_tableau = { "Workers : ", "Happiness : ",   "Food left : ", "Housing left : ",  "Total Production : " };
