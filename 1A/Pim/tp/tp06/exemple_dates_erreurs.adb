...
begin
    ...
    --Afficher_Deux_Positions (2);  --Afficher_Deux_Positions est définie dans le body mais pas dans le corps
    New_Line;
    ...
    --Une_Date.jour := 15;    -- le type Une_date est privé
    --Une_Date.Mois := Mois_Suivant;   -- le type Une_date est privé
    Afficher (Une_Date);
    New_Line;
