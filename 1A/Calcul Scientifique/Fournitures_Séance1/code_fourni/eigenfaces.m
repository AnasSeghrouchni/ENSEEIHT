...
for j = 1:nb_personnes_base,
	...
	for k = liste_postures_base,
        ...
        ficF = strcat('/home/aseghrou/1A/calcul_scientifique/Fournitures_Séance1/code_fourni/Data/', liste_personnes_base{j}, liste_postures{k}, '-300x400.gif');
...
afficher_individu_moyen=reshape(individu_moyen,[],300);
figure
colormap(gray(256));
imagesc(afficher_individu_moyen);
